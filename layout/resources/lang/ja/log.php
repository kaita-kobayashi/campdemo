...
return [
    ...
    'postAnalytics'             => [ 'event_name' => '4',           'function_name' => __('analytics.title.select') ],
    'getAnalyticsSummary'       => [ 'event_name' => '4',           'function_name' => __('analytics.title.summary') ],
    'getAnalyticsTransition'    => [ 'event_name' => '4',           'function_name' => __('analytics.title.transition') ],
    'getAnalyticsGender'        => [ 'event_name' => '4',           'function_name' => __('analytics.title.gender') ],
    'getAnalyticsAge'           => [ 'event_name' => '4',           'function_name' => __('analytics.title.age') ],
    'getAnalyticsEria'          => [ 'event_name' => '4',           'function_name' => __('analytics.title.eria') ],
];
